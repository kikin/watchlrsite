...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.result'
        db.add_column('api_video', 'result', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.result'
        db.delete_column('api_video', 'result')
