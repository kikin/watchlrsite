...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.task_id'
        db.add_column('api_video', 'task_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Video.task_id'
        db.delete_column('api_video', 'task_id')
