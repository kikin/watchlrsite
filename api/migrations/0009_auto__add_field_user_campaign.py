...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.campaign'
        db.add_column('api_user', 'campaign', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.campaign'
        db.delete_column('api_user', 'campaign')
