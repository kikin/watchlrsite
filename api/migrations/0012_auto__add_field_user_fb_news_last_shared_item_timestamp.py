...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.fb_news_last_shared_item_timestamp'
        db.add_column('api_user', 'fb_news_last_shared_item_timestamp', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding index on 'User', fields ['fb_news_feed_fetched']
        db.create_index('api_user', ['fb_news_feed_fetched'])

        # Adding index on 'User', fields ['fb_friends_fetched']
        db.create_index('api_user', ['fb_friends_fetched'])


    def backwards(self, orm):
        
        # Removing index on 'User', fields ['fb_friends_fetched']
        db.delete_index('api_user', ['fb_friends_fetched'])

        # Removing index on 'User', fields ['fb_news_feed_fetched']
        db.delete_index('api_user', ['fb_news_feed_fetched'])

        # Deleting field 'User.fb_news_last_shared_item_timestamp'
        db.delete_column('api_user', 'fb_news_last_shared_item_timestamp')
    ...
    models = {
        ...
        'api.user': {
            ...
            'fb_news_last_shared_item_timestamp': ('django.db.models.fields.DateField', [], {'null': 'True'}),
