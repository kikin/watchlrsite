...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('api_user', 'karma', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.karma'
        db.delete_column('api_user', 'karma')
