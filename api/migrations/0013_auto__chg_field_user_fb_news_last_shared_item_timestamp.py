...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.fb_news_last_shared_item_timestamp'
        db.alter_column('api_user', 'fb_news_last_shared_item_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'User.fb_news_last_shared_item_timestamp'
        db.alter_column('api_user', 'fb_news_last_shared_item_timestamp', self.gf('django.db.models.fields.DateField')(null=True))
