...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Video._url_hash' to match new field type.
        db.rename_column('api_video', '_url_hash', 'url_hash')
        # Changing field 'Video._url_hash'
        db.alter_column('api_video', 'url_hash', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, db_column='url_hash'))


    def backwards(self, orm):
        
        # Renaming column for 'Video._url_hash' to match new field type.
        db.rename_column('api_video', 'url_hash', '_url_hash')
        # Changing field 'Video._url_hash'
        db.alter_column('api_video', '_url_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
