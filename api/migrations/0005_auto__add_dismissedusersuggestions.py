...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DismissedUserSuggestions'
        db.create_table('api_dismissedusersuggestions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['api.User'])),
            ('suggested_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['api.User'])),
            ('dismissed_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('api', ['DismissedUserSuggestions'])


    def backwards(self, orm):
        
        # Deleting model 'DismissedUserSuggestions'
        db.delete_table('api_dismissedusersuggestions')
