...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.have_publish_rights'
        db.add_column('api_user', 'have_publish_rights', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.have_publish_rights'
        db.delete_column('api_user', 'have_publish_rights')
