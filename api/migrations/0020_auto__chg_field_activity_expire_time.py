...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Activity.expire_time'
        db.alter_column('api_activity', 'expire_time', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        'api.activity': {
            ...
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
