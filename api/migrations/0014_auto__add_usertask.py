...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_usertask', (
            ...
            ('result', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, db_index=True)),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
        ))
        db.send_create_signal('api', ['UserTask'])


    def backwards(self, orm):
        
        # Deleting model 'UserTask'
        db.delete_table('api_usertask')
    ...
    models = {
        ...
        'api.usertask': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'db_index': 'True'}),
