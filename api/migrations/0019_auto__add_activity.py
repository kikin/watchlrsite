...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['api.User'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['api.Video'])),
            ('friend', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['api.User'])),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
            ('insert_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('expire_time', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal('api', ['Activity'])


    def backwards(self, orm):
        
        # Deleting model 'Activity'
        db.delete_table('api_activity')
    ...
    models = {
        'api.activity': {
            ...
            'expire_time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'friend': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['api.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'insert_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['api.User']"}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['api.Video']"})
        },
        ...
        'api.user': {
            ...
            'fb_friends_fetched': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'fb_news_feed_fetched': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'db_index': 'True'}),
            'fb_news_last_shared_item_timestamp': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'have_publish_rights': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_fetch_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
        ...
        'api.usertask': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.CharField', [], {'default': "'PENDING'", 'max_length': '10', 'null': 'True', 'db_index': 'True'}),
        ...
        'api.video': {
            ...
            '_url_hash': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'db_column': "'url_hash'"}),
