...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Activity.insert_time'
        db.alter_column('api_activity', 'insert_time', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Activity.expire_time'
        db.alter_column('api_activity', 'expire_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 12, 4, 23, 20, 1, 686607)))


    def backwards(self, orm):
        
        # Changing field 'Activity.insert_time'
        db.alter_column('api_activity', 'insert_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Activity.expire_time'
        db.alter_column('api_activity', 'expire_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        'api.activity': {
            ...
            'insert_time': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
