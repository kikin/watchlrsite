...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video._url_hash'
        db.add_column('api_video', '_url_hash', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video._url_hash'
        db.delete_column('api_video', '_url_hash')
    ...
    models = {
        ...
        'api.video': {
            ...
            '_url_hash': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
