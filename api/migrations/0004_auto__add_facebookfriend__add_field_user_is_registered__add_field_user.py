...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_facebookfriend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fb_user_set', to=orm['api.User'])),
            ('fb_friend', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fb_friend_set', to=orm['api.User'])),
            ('invited_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('api', ['FacebookFriend'])

        # Adding field 'User.is_registered'
        db.add_column('api_user', 'is_registered', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'User.fb_friends_fetched'
        db.add_column('api_user', 'fb_friends_fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'FacebookFriend'
        db.delete_table('api_facebookfriend')

        # Deleting field 'User.is_registered'
        db.delete_column('api_user', 'is_registered')

        # Deleting field 'User.fb_friends_fetched'
        db.delete_column('api_user', 'fb_friends_fetched')


    models = {
        'api.facebookfriend': {
            'Meta': {'object_name': 'FacebookFriend'},
            'fb_friend': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fb_friend_set'", 'to': "orm['api.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invited_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fb_user_set'", 'to': "orm['api.User']"})
        },
        'api.notification': {
        ...
        'api.user': {
            ...
            'fb_friends': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'r_user_set'", 'symmetrical': 'False', 'through': "orm['api.FacebookFriend']", 'to': "orm['api.User']"}),
