...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserVideo.position'
        db.delete_column('api_uservideo', 'position')

        # Adding field 'UserVideo._position'
        db.add_column('api_uservideo', '_position', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserVideo.position'
        db.add_column('api_uservideo', 'position', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2), keep_default=False)

        # Deleting field 'UserVideo._position'
        db.delete_column('api_uservideo', '_position')
