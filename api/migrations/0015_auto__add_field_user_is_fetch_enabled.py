...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.is_fetch_enabled'
        db.add_column('api_user', 'is_fetch_enabled', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)

        # Adding index on 'User', fields ['is_registered']
        db.create_index('api_user', ['is_registered'])


    def backwards(self, orm):
        
        # Removing index on 'User', fields ['is_registered']
        db.delete_index('api_user', ['is_registered'])

        # Deleting field 'User.is_fetch_enabled'
        db.delete_column('api_user', 'is_fetch_enabled')
