...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserVideo.shared_timestamp'
        db.add_column('api_uservideo', 'shared_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)

        # Adding field 'User.fb_news_feed_fetched'
        db.add_column('api_user', 'fb_news_feed_fetched', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserVideo.shared_timestamp'
        db.delete_column('api_uservideo', 'shared_timestamp')

        # Deleting field 'User.fb_news_feed_fetched'
        db.delete_column('api_user', 'fb_news_feed_fetched')
