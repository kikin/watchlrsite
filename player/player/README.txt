...
If src points to a resource at vimeo.com, run an ugly routine to get the raw mp4 stream (see com.watchlr.GigaPlayer.Util.Util) and load that into the VideoDisplay.

If src points to a resource at youtube.com or yt.com, hide the VideoDisplay and present a chromeless YouTube player in its place ("_youTubeLoader" member of the GigaPlayer class).  
